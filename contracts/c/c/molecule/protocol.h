...
#define MolReader_Flag_2_has_extra_fields(s) mol_table_has_extra_fields(s, 1)
...
#define MolBuilder_Flag_2_init(b) mol_table_builder_initialize(b, 256, 1)
...
#define ____ 0x00
    ...
    MOLECULE_API_DECORATOR const uint8_t MolDefault_Flag_2[40] = {
        0x28,
        ____,
        ____,
        ____,
