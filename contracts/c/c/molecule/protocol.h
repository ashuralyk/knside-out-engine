...
MOLECULE_API_DECORATOR  mol_errno       MolReader_ProjectInfo_verify                    (const mol_seg_t*, bool);
#define                                 MolReader_ProjectInfo_actual_field_count(s)     mol_table_actual_field_count(s)
#define                                 MolReader_ProjectInfo_has_extra_fields(s)       mol_table_has_extra_fields(s, 4)
#define                                 MolReader_ProjectInfo_get_name(s)               mol_table_slice_by_index(s, 0)
#define                                 MolReader_ProjectInfo_get_author(s)             mol_table_slice_by_index(s, 1)
#define                                 MolReader_ProjectInfo_get_website(s)            mol_table_slice_by_index(s, 2)
#define                                 MolReader_ProjectInfo_get_description(s)        mol_table_slice_by_index(s, 3)
MOLECULE_API_DECORATOR  mol_errno       MolReader_Deployment_verify                     (const mol_seg_t*, bool);
#define                                 MolReader_Deployment_actual_field_count(s)      mol_table_actual_field_count(s)
#define                                 MolReader_Deployment_has_extra_fields(s)        mol_table_has_extra_fields(s, 2)
#define                                 MolReader_Deployment_get_code(s)                mol_table_slice_by_index(s, 0)
#define                                 MolReader_Deployment_get_project(s)             mol_table_slice_by_index(s, 1)
...
#define                                 MolReader_Flag_1_has_extra_fields(s)            mol_table_has_extra_fields(s, 2)
#define                                 MolReader_Flag_1_get_project_id(s)              mol_table_slice_by_index(s, 0)
#define                                 MolReader_Flag_1_get_owner_lockscript(s)        mol_table_slice_by_index(s, 1)
...
#define                                 MolReader_Flag_2_get_project_id(s)              mol_table_slice_by_index(s, 0)
#define                                 MolReader_Flag_2_get_method(s)                  mol_table_slice_by_index(s, 1)
#define                                 MolReader_Flag_2_get_function_call(s)           mol_table_slice_by_index(s, 2)
...
#define                                 MolBuilder_ProjectInfo_init(b)                  mol_table_builder_initialize(b, 256, 4)
#define                                 MolBuilder_ProjectInfo_set_name(b, p, l)        mol_table_builder_add(b, 0, p, l)
#define                                 MolBuilder_ProjectInfo_set_author(b, p, l)      mol_table_builder_add(b, 1, p, l)
#define                                 MolBuilder_ProjectInfo_set_website(b, p, l)     mol_table_builder_add(b, 2, p, l)
#define                                 MolBuilder_ProjectInfo_set_description(b, p, l) mol_table_builder_add(b, 3, p, l)
MOLECULE_API_DECORATOR  mol_seg_res_t   MolBuilder_ProjectInfo_build                    (mol_builder_t);
#define                                 MolBuilder_ProjectInfo_clear(b)                 mol_builder_discard(b)
#define                                 MolBuilder_Deployment_init(b)                   mol_table_builder_initialize(b, 256, 2)
#define                                 MolBuilder_Deployment_set_code(b, p, l)         mol_table_builder_add(b, 0, p, l)
#define                                 MolBuilder_Deployment_set_project(b, p, l)      mol_table_builder_add(b, 1, p, l)
MOLECULE_API_DECORATOR  mol_seg_res_t   MolBuilder_Deployment_build                     (mol_builder_t);
#define                                 MolBuilder_Deployment_clear(b)                  mol_builder_discard(b)
...
#define                                 MolBuilder_Flag_1_init(b)                       mol_table_builder_initialize(b, 256, 2)
#define                                 MolBuilder_Flag_1_set_project_id(b, p, l)       mol_table_builder_add(b, 0, p, l)
#define                                 MolBuilder_Flag_1_set_owner_lockscript(b, p, l) mol_table_builder_add(b, 1, p, l)
...
#define                                 MolBuilder_Flag_2_init(b)                       mol_table_builder_initialize(b, 256, 3)
#define                                 MolBuilder_Flag_2_set_project_id(b, p, l)       mol_table_builder_add(b, 0, p, l)
#define                                 MolBuilder_Flag_2_set_method(b, p, l)           mol_table_builder_add(b, 1, p, l)
#define                                 MolBuilder_Flag_2_set_function_call(b, p, l)    mol_table_builder_add(b, 2, p, l)
...
MOLECULE_API_DECORATOR const uint8_t MolDefault_ProjectInfo[36]  =  {
    0x24, ____, ____, ____, 0x14, ____, ____, ____, 0x18, ____, ____, ____,
    0x1c, ____, ____, ____, 0x20, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
};
MOLECULE_API_DECORATOR const uint8_t MolDefault_Deployment[52]   =  {
    0x34, ____, ____, ____, 0x0c, ____, ____, ____, 0x10, ____, ____, ____,
    ____, ____, ____, ____, 0x24, ____, ____, ____, 0x14, ____, ____, ____,
    0x18, ____, ____, ____, 0x1c, ____, ____, ____, 0x20, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____,
};
...
MOLECULE_API_DECORATOR const uint8_t MolDefault_Flag_1[48]       =  {
    0x30, ____, ____, ____, 0x0c, ____, ____, ____, 0x2c, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
};
MOLECULE_API_DECORATOR const uint8_t MolDefault_Flag_2[56]       =  {
...
MOLECULE_API_DECORATOR mol_errno MolReader_ProjectInfo_verify (const mol_seg_t *input, bool compatible) {
...
MOLECULE_API_DECORATOR mol_errno MolReader_Deployment_verify (const mol_seg_t *input, bool compatible) {
    if (input->size < MOL_NUM_T_SIZE) {
        return MOL_ERR_HEADER;
    }
    uint8_t *ptr = input->ptr;
    ...
    offsets[field_count] = total_size;
        ...
        inner.ptr = input->ptr + offsets[1];
        inner.size = offsets[2] - offsets[1];
        errno = MolReader_ProjectInfo_verify(&inner, compatible);
        if (errno != MOL_OK) {
            return MOL_ERR_DATA;
        }
    return MOL_OK;
...
MOLECULE_API_DECORATOR mol_seg_res_t MolBuilder_ProjectInfo_build (mol_builder_t builder) {
    mol_seg_res_t res;
    res.errno = MOL_OK;
    mol_num_t offset = 20;
    mol_num_t len;
...
MOLECULE_API_DECORATOR mol_seg_res_t MolBuilder_Deployment_build (mol_builder_t builder) {
    mol_seg_res_t res;
    res.errno = MOL_OK;
    mol_num_t offset = 12;
    mol_num_t len;
    ...
    if (len == 0) {
        len = 36;
        memcpy(dst, &MolDefault_ProjectInfo, len);
    } else {
        mol_num_t of = builder.number_ptr[2];
        memcpy(dst, src+of, len);
    }
