...
#define                                 MolReader_Flag_2_get_function_call(s)           mol_table_slice_by_index(s, 1)
#define                                 MolReader_Flag_2_get_caller_lockscript(s)       mol_table_slice_by_index(s, 2)
...
#define                                 MolBuilder_Flag_2_set_function_call(b, p, l)    mol_table_builder_add(b, 1, p, l)
#define                                 MolBuilder_Flag_2_set_caller_lockscript(b, p, l) mol_table_builder_add(b, 2, p, l)
